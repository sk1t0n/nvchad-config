...
- The plugins are configured:
  ...
  - [conform.nvim](https://github.com/stevearc/conform.nvim) (automatic formatting of code, for JS/TS you need the configuration file [biome.json](https://github.com/sk1t0n/nvchad_config/blob/master/biome.json) in the root folder, for YAML you need the configuration file [yamlfmt.yml](https://github.com/sk1t0n/nvchad_config/blob/master/yamlfmt.yml) in the root folder),

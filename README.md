...
This is a user configuration for Neovim based on [NvChad](https://github.com/NvChad/starter). Plugins for PHP (Laravel), Go, Rust, Zig, Lua, JavaScript/TypeScript (React), JSON, HTML (Emmet), CSS (Tailwind), Docker, YAML, SQL, Markdown are added and configured.

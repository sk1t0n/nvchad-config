...
This is a user configuration for Neovim based on [NvChad](https://github.com/NvChad/starter). Plugins for Go, PHP, Ruby, JavaScript, TypeScript, Lua, HTML, CSS, JSON, YAML, Docker are configured.
...
- The configured plugins:
  ...
  - [neotest](https://github.com/nvim-neotest/neotest) (run tests for Go ([neotest-golang](https://github.com/fredrikaverpil/neotest-golang)), PHP ([neotest-pest](https://github.com/V13Axel/neotest-pest)))
